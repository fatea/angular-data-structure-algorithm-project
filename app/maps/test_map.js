...
//TODO:QRST四个点什么情况啊!!!!!!
  ...
  //map.addEdge(new Edge(map, 'A', 'B', 1.70));
  //map.addEdge(new Edge(map, 'A', 'D', 1.20));
  //map.addEdge(new Edge(map, 'B', 'C', 0.81));
  //
  ...
  //map.addEdge(new Edge(map, 'P', 'Q', 0.62));
  //map.addEdge(new Edge(map, 'P', 'T', 0.62));
  //map.addEdge(new Edge(map, 'Q', 'R', 0.73));
  //map.addEdge(new Edge(map, 'Q', 'S', 0.51));
  //map.addEdge(new Edge(map, 'Q', 'T', 0.93));
  ...
  //map.addEdge(new Edge(map, 'U', 'V', 0.99));

  map.addEdge(new Edge(map, 'X', 'U', 0.65));

  //map.addEdge(new Edge(map, 'U', 'Z', 1.70));
  //map.addEdge(new Edge(map, 'V', 'X', 0.58));
  //map.addEdge(new Edge(map, 'V', 'W', 1.10));
  //map.addEdge(new Edge(map, 'W', 'X', 0.57));
